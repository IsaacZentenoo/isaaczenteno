...
function MoviePage() {
  ...
  const handleLike = () => {
    axios.post(`http://localhost:4000/api/movies/${id}/like`, {}, axiosConfig).then(res => setMovie(res.data));
  };

  const handleDislike = () => {
    axios.post(`http://localhost:4000/api/movies/${id}/dislike`, {}, axiosConfig).then(res => setMovie(res.data));
  };
